...
plot_model(model, to_file='models/denseNet169_JAFFE.png', show_shapes=True,show_layer_names=True)
Image(filename='models/denseNet169_JAFFE.png') 
...
plt.savefig('accuracy_plots/accuracy_denseNet169_JAFFE.png')