...
plot_model(model, to_file='denseNet169_JAFFE.png', show_shapes=True,show_layer_names=True)
Image(filename='denseNet169_JAFFE.png') 
...
#save model
model.save('denseNet169_JAFFE.h5')
...
plt.savefig('accuracy_denseNet169_JAFFE.png')