...
plot_model(model, to_file='vgg16_JAFFE.png', show_shapes=True,show_layer_names=True)
Image(filename='vgg16_JAFFE.png') 
...
plt.savefig('accuracy_vgg16_JAFFE.png')