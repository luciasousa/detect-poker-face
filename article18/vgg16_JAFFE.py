...
plot_model(model, to_file='models/vgg16_JAFFE.png', show_shapes=True,show_layer_names=True)
Image(filename='models/vgg16_JAFFE.png') 
...
plt.savefig('accuracy_plots/accuracy_vgg16_JAFFE.png')