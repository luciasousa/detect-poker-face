...
IMAGE_SIZE = [96, 96]
# create the base pre-trained model for binary classification
#create base model with image size 96x96x1
base_model = EfficientNetB0(input_shape=IMAGE_SIZE + [1], weights='imagenet', include_top=False)
#base_model = EfficientNetB0(input_shape=(96,96,3), weights=None, include_top=False)
...
#save model
model.save('efficientNetB0_JAFFE_binary_classification.h5')
...
#Train accuracy:  0.8638743162155151