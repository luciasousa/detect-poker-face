...
for label in labels:
    ...
    for img in img_list:
        ...
        img_names_tmp.append(label+'_'+img)
...
print('Number of neutral samples:',np.sum(labels_int==0))
print('Number of not neutral samples:',np.sum(labels_int==1))
